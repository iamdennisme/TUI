...
local function StyleButton(self)
	...
	if normal then
		...
		self:SetNormalTexture(path.."textureNormal")

		self:SetCheckedTexture(path.."textureChecked")
		self:GetCheckedTexture():SetAllPoints(normal)

		self:SetPushedTexture(path.."texturePushed")
		self:GetPushedTexture():SetAllPoints(normal)

		self:SetHighlightTexture(path.."textureHighlight")
	...
	if ( not self.Background ) then
		...
		self.Background:SetTexture(path.."textureBackground")
	...
	if ( not floatingBG ) then
		...
		self.floatingBG:SetTexture(path.."textureShadow")
